...
- A hint for viewing the lectures online: Click the links in the ReadMe File.  The lectures are published through Posit Connect Cloud (will learn more about this later).
:::
...
- [Past Me](https://github.com/njsilbiger/Intertidal-Benthic-Pelagic/tree/main)  
- [Tena Dhayalan](https://github.com/tenadhayalan/Asymmetric_metabolic_responses_of_rockweed_and_herbivores/tree/main)
...
## For Homework today you have three tasks
...
3. Edit your readme file to say something *useful* about your repository (and you!).
