...
```{r rexper-plot, echo=FALSE, warning=FALSE, message=FALSE, fig.width=10, fig.height=6}
Rexper
```
...
- Share code and data on a public version-controlled repository
...
## We will create beautiful graphics using #TidyTuesday
...
I created a class Slack channel for asking classmates for help, sharing advice, and sharing resources.
...
- Weekly lab assignments due the following week
...
- Covers required readings, labs, and lectures
- Open notes — but no discussing with classmates
- Only 10 mins, so come prepared and on time!
...
- Visualization and explanation of a dataset of your choosing (your own work or found data)
